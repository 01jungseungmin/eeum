...
public interface ChatRoomRepositoryCustom {
     ...
     */
    Slice<ChatRoom> findMyRooms(Long accountId, ChatRoomCursor cursor, int size, boolean includeClosed);

    // 지역 내 공개 채팅방 목록 (GROUP/GROUP_STREET, isActive=true) — 무한 스크롤
    Slice<ChatRoom> findPublicRooms(Long regionId, ChatRoomCursor cursor, int size);
