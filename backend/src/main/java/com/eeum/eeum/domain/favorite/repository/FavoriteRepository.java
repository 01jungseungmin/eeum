...
public interface FavoriteRepository
    ...
    /**
     * 대상 도메인 삭제 시 CASCADE 찜 일괄 삭제.
     * 단일 DELETE 쿼리 실행 (파생 쿼리의 N+1 DELETE 방지).
     */
    @Modifying
    ...
    /**
     * 사장용 찜 고객 목록 — Account JOIN FETCH로 N+1 방지.
     * @ManyToOne 페치이므로 Pagination과 병용해도 안전하다.
     */
    @Query(value = """
