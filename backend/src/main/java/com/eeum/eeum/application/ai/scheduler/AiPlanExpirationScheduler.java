...
public class AiPlanExpirationScheduler {
    ...
    public void expireSubscriptions() {
        ...
        List<AiPlanSubscription> expired = aiPlanSubscriptionRepository
                .findByActiveTrueAndExpiredAtBeforeOrderByExpiredAtAscAiPlanSubscriptionIdAsc(
                        now, PageRequest.of(0, EXPIRATION_BATCH_SIZE));
        ...
        List<AiPlanSubscription> reserved = aiPlanSubscriptionRepository
                .findByActiveFalseAndStartedAtLessThanEqualAndExpiredAtAfterOrderByStartedAtAscAiPlanSubscriptionIdAsc(
                        now, now, PageRequest.of(0, EXPIRATION_BATCH_SIZE));
