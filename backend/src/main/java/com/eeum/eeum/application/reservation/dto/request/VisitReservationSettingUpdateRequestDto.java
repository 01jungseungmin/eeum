...
public class VisitReservationSettingUpdateRequestDto {
    ...
    @NotNull(message = "기본 최대 수용 인원은 필수입니다.")
    @Min(value = 1, message = "기본 최대 수용 인원은 1명 이상이어야 합니다.")
    @Schema(description = "기본 최대 수용 인원", example = "5")
    private Integer defaultMaxVisitorCount;

    @NotNull(message = "기본 최대 팀 수는 필수입니다.")
    @Min(value = 1, message = "기본 최대 팀 수는 1팀 이상이어야 합니다.")
    @Schema(description = "기본 최대 팀 수", example = "2")
