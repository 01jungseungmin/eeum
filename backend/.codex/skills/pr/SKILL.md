---
name: pr
description: "사용자가 현재 브랜치 변경사항을 바탕으로 PR 제목, PR 본문, 테스트 체크리스트, 리뷰 포인트와 Worklog 작성을 요청할 때 사용한다."
---

이 skill의 지시는 `.claude/commands/pr.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
