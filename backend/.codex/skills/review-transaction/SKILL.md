...
description: "Service, 이벤트, 리스너, 스케줄러 변경의 트랜잭션 경계, readOnly, 락, 도메인 이벤트, 예외와 ErrorCode를 검토할 때 사용한다."
---

이 skill의 지시는 `.claude/agents/review-transaction.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
