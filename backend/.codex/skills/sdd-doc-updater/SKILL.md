...
description: "SDD 최신화, SDD 문서 갱신, 코드 기준 SDD 수정을 요청받았을 때 현재 구현이 더 최신이거나 안전한 부분을 관련 설계 문서에 반영한다."
---

이 skill의 지시는 `.claude/agents/sdd-doc-updater.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
