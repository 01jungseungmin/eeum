---
name: education
description: "사용자가 프로젝트 코드의 역할, 흐름, 설계 의도나 Spring, JPA, Redis, WebSocket, Transaction 개념을 학습하거나 쉽게 설명해 달라고 할 때 사용한다."
---

이 skill의 지시는 `.claude/agents/education.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
