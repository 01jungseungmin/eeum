...
description: "SDD 원문을 최초로 분리하거나 원문이 갱신되어 ../docs/sdd/full.md를 도메인별 Markdown으로 다시 분류해야 할 때 사용한다."
---

이 skill의 지시는 `.claude/agents/sdd-domain-extractor.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
