---
name: refactor
description: "기능과 외부 API 계약을 유지하면서 Service, Repository, Entity의 책임 분리, 중복 제거, 네이밍, 성능, 테스트 가능성 개선안을 제안할 때 사용한다."
---

이 skill의 지시는 `.claude/agents/refactor.md`에 있다. **그 파일을 처음부터 끝까지 읽고 그대로 따른다.**
